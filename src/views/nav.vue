<template>
    ...
    <aside class="color-nav nav-user d-flex flex-column" v-if="perfil == 'Usuario pro (empresa)'">
        <div class="d-flex flex-column align-items-center" >
            <div class="logo">
                <img  class="w-100 logo" :src="logoNeva" @click="ir('HomeDashboard')" style="cursor:pointer" alt="">
            </div>
            <div>
                <div>
                    <img :src="logoConfiguracion" @click="AbrirMenu" style="cursor:pointer" alt="">
                </div>
            </div>
        </div>
        <div class="d-flex flex-column  align-items-center">
            <div>
                <img :src="logoMas" @click="logout" style="cursor:pointer" alt="">
            </div>
        </div>
    </aside>
    ...
    <aside class="color-nav nav-user d-flex flex-column" v-if="perfil == 'Gran empresa'">
        <div class="d-flex flex-column align-items-center">
            <div class="logo">
                <img  class="w-100 logo" :src="logoNeva" @click="ir('HomeDashboardGranEmpresa')" style="cursor:pointer" alt="">
            </div>
            <div>
            </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
            <div class="accordion-body">
              <ul>
                <li @click="ir('Permisos')" style="cursor:pointer">Crear Usuario</li>
              </ul>
            </div>
          </div>
        </div>
