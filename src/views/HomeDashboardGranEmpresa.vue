                ...
                <table class="table table-hover">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="img-left me-lg-3">
                          <img class="company" src="../assets/img/clientes/logo_latam.jpg" alt="">
                        </div>
                      </td>
                      <td>
                        <div class="me-md-3">
                          <h4 class="text-center text-md-start">Gran Empresa #1</h4>
                          <div class="d-flex align-items-center data-icon justify-content-center justify-content-md-between flex-wrap">
                            <div class="d-flex align-items-center ">
                              <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p class="responsible-table">100% Completado</p>
                            </div>
                          </div>
                      </div>
                      </td>
                        ...
                        <div class="me-md-3">
                          ...
                          <div class="d-flex align-items-center data-icon justify-content-center justify-content-md-between flex-wrap">
                              <div class="d-flex align-items-center ">
                                  ...
                                  <p class="responsible">01-01-23</p>
                              </div>
                          </div>
                      </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="me-md-3">
                          <h4 class="text-center text-md-start">Gran empresa #2</h4>
                          <div class="d-flex align-items-center data-icon justify-content-center justify-content-md-between flex-wrap">
                            <div class="d-flex align-items-center color-warning ">
                              ...
                              <p class="responsible-table">70% Completado</p>
                          </div>
                          </div>
                      </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="me-md-3">
                          <h4 class="text-center text-md-start">Gran Empresa #3</h4>
                          <div class="d-flex align-items-center data-icon justify-content-center justify-content-md-between flex-wrap">
                            <div class="d-flex align-items-center ">
                              <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_258_1364)">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="me-md-3">
                          <h4 class="text-center text-md-start">Gran Empresa #4</h4>
                          <div class="d-flex align-items-center data-icon justify-content-center justify-content-md-between flex-wrap">
                            <div class="d-flex align-items-center color-warning">
                              <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_258_1364)">
                              ...
                              <p class="responsible-table">10% Completado</p>
                          </div>
                          </div>
                      </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="me-md-3">
                          <h4 class="text-center text-md-start">Gran Empresa #5</h4>
                          <div class="d-flex align-items-center data-icon justify-content-center justify-content-md-between flex-wrap">
                            <div class="d-flex align-items-center ">
                              <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_258_1364)">
