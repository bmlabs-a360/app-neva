          ...
          <tr v-for="user in usuarios" :key="user.id">
            ...
            <td>
              <div class="iconstableuser">
                <div>
                  <a href="#">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" @click="ir('AreaEvaluacion', user)" v-c-tooltip="{content: 'Asignar area', placement: 'top'}">
                ...
                <div>
                  <a href="#">
                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" @click="ir('EditarUsuario', user)"  v-c-tooltip="{content: 'Editar usuario', placement: 'top'}">
                ...
                <div>
                  <a data-bs-toggle="modal" data-bs-target="#exampleModal" :disabled="deleteUserDisabled(user)">
                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" @click="getUserDelete(user)" :disabled="deleteUserDisabled(user)"  v-c-tooltip="{content: 'Eliminar usuario', placement: 'top'}">
